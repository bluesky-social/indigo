...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile("events/cbor_gen.go", "events", events.EventHeader{}, events.RepoEvent{}, events.RepoAppend{}, events.RepoOp{}, events.Label{}, events.LabelEvent{}); err != nil {
		panic(err)
	}
