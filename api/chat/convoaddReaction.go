...
// Lexicon schema: chat.bsky.convo.addReaction
...
func ConvoAddReaction(ctx context.Context, c lexutil.LexClient, input *ConvoAddReaction_Input) (*ConvoAddReaction_Output, error) {
	var out ConvoAddReaction_Output
	if err := c.LexDo(ctx, lexutil.Procedure, "application/json", "chat.bsky.convo.addReaction", nil, input, &out); err != nil {
		return nil, err
	}
