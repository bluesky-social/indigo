...
// schema: chat.gndr.convo.removeReaction
...
// ConvoRemoveReaction_Input is the input argument to a chat.gndr.convo.removeReaction call.
...
// ConvoRemoveReaction_Output is the output of a chat.gndr.convo.removeReaction call.
type ConvoRemoveReaction_Output struct {
	Message *ConvoDefs_MessageView `json:"message" cborgen:"message"`
}

// ConvoRemoveReaction calls the XRPC method "chat.gndr.convo.removeReaction".
func ConvoRemoveReaction(ctx context.Context, c util.LexClient, input *ConvoRemoveReaction_Input) (*ConvoRemoveReaction_Output, error) {
	...
	if err := c.LexDo(ctx, util.Procedure, "application/json", "chat.gndr.convo.removeReaction", nil, input, &out); err != nil {
		return nil, err
	}
