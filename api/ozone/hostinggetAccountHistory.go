...
// Lexicon schema: tools.ozone.hosting.getAccountHistory
...
type HostingGetAccountHistory_EmailConfirmed struct {
	LexiconTypeID string `json:"$type" cborgen:"$type,const=tools.ozone.hosting.getAccountHistory#emailConfirmed"`
...
type HostingGetAccountHistory_EmailUpdated struct {
	LexiconTypeID string `json:"$type" cborgen:"$type,const=tools.ozone.hosting.getAccountHistory#emailUpdated"`
	Email         string `json:"email" cborgen:"email"`
}
