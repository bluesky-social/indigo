...
// schema: tools.ozone.moderation.scheduleAction
...
//
// RECORDTYPE: ModerationScheduleAction_Takedown
type ModerationScheduleAction_Takedown struct {
	LexiconTypeID string `json:"$type,const=tools.ozone.moderation.scheduleAction#takedown" cborgen:"$type,const=tools.ozone.moderation.scheduleAction#takedown"`
