...
func SetAddValues(ctx context.Context, c lexutil.LexClient, input *SetAddValues_Input) error {
	if err := c.LexDo(ctx, lexutil.Procedure, "application/json", "tools.ozone.set.addValues", nil, input, nil); err != nil {
		return err
	}
