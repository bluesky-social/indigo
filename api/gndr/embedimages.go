...
func init() {
	util.RegisterType("gndr.app.embed.images#main", &EmbedImages{})
} // EmbedImages is a "main" in the gndr.app.embed.images schema.
// RECORDTYPE: EmbedImages
type EmbedImages struct {
	LexiconTypeID string               `json:"$type,const=gndr.app.embed.images" cborgen:"$type,const=gndr.app.embed.images"`
	Images        []*EmbedImages_Image `json:"images" cborgen:"images"`
}

// EmbedImages_Image is a "image" in the gndr.app.embed.images schema.
...
// EmbedImages_View is a "view" in the gndr.app.embed.images schema.
//
// RECORDTYPE: EmbedImages_View
type EmbedImages_View struct {
	LexiconTypeID string                   `json:"$type,const=gndr.app.embed.images#view" cborgen:"$type,const=gndr.app.embed.images#view"`
	Images        []*EmbedImages_ViewImage `json:"images" cborgen:"images"`
}

// EmbedImages_ViewImage is a "viewImage" in the gndr.app.embed.images schema.
