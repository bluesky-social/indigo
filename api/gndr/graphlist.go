...
func init() {
	util.RegisterType("gndr.app.graph.list", &GraphList{})
} //
// RECORDTYPE: GraphList
type GraphList struct {
	LexiconTypeID     string            `json:"$type,const=gndr.app.graph.list" cborgen:"$type,const=gndr.app.graph.list"`
