...
// schema: gndr.app.graph.verification
...
func init() {
	util.RegisterType("gndr.app.graph.verification", &GraphVerification{})
} //
// RECORDTYPE: GraphVerification
type GraphVerification struct {
	LexiconTypeID string `json:"$type,const=gndr.app.graph.verification" cborgen:"$type,const=gndr.app.graph.verification"`
