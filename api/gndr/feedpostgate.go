...
func init() {
	util.RegisterType("gndr.app.feed.postgate", &FeedPostgate{})
} //
// RECORDTYPE: FeedPostgate
type FeedPostgate struct {
	LexiconTypeID string `json:"$type,const=gndr.app.feed.postgate" cborgen:"$type,const=gndr.app.feed.postgate"`
...
// FeedPostgate_DisableRule is a "disableRule" in the gndr.app.feed.postgate schema.
//
// Disables embedding of this post.
//
// RECORDTYPE: FeedPostgate_DisableRule
type FeedPostgate_DisableRule struct {
	LexiconTypeID string `json:"$type,const=gndr.app.feed.postgate#disableRule" cborgen:"$type,const=gndr.app.feed.postgate#disableRule"`
}
