...
// schema: gndr.app.feed.generator
...
func init() {
	util.RegisterType("gndr.app.feed.generator", &FeedGenerator{})
} //
// RECORDTYPE: FeedGenerator
type FeedGenerator struct {
	LexiconTypeID string `json:"$type,const=gndr.app.feed.generator" cborgen:"$type,const=gndr.app.feed.generator"`
	// acceptsInteractions: Declaration that a feed accepts feedback interactions from a client through gndr.app.feed.sendInteractions
