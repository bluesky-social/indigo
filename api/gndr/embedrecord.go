...
func init() {
	util.RegisterType("gndr.app.embed.record#main", &EmbedRecord{})
} // EmbedRecord is a "main" in the gndr.app.embed.record schema.
// RECORDTYPE: EmbedRecord
type EmbedRecord struct {
	LexiconTypeID string                         `json:"$type,const=gndr.app.embed.record" cborgen:"$type,const=gndr.app.embed.record"`
	Record        *comatprototypes.RepoStrongRef `json:"record" cborgen:"record"`
}

// EmbedRecord_View is a "view" in the gndr.app.embed.record schema.
//
// RECORDTYPE: EmbedRecord_View
type EmbedRecord_View struct {
	LexiconTypeID string                   `json:"$type,const=gndr.app.embed.record#view" cborgen:"$type,const=gndr.app.embed.record#view"`
	Record        *EmbedRecord_View_Record `json:"record" cborgen:"record"`
}

// EmbedRecord_ViewBlocked is a "viewBlocked" in the gndr.app.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewBlocked
type EmbedRecord_ViewBlocked struct {
	LexiconTypeID string                  `json:"$type,const=gndr.app.embed.record#viewBlocked" cborgen:"$type,const=gndr.app.embed.record#viewBlocked"`
	Author        *FeedDefs_BlockedAuthor `json:"author" cborgen:"author"`
	Blocked       bool                    `json:"blocked" cborgen:"blocked"`
	Uri           string                  `json:"uri" cborgen:"uri"`
}

// EmbedRecord_ViewDetached is a "viewDetached" in the gndr.app.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewDetached
type EmbedRecord_ViewDetached struct {
	LexiconTypeID string `json:"$type,const=gndr.app.embed.record#viewDetached" cborgen:"$type,const=gndr.app.embed.record#viewDetached"`
	Detached      bool   `json:"detached" cborgen:"detached"`
	Uri           string `json:"uri" cborgen:"uri"`
}

// EmbedRecord_ViewNotFound is a "viewNotFound" in the gndr.app.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewNotFound
type EmbedRecord_ViewNotFound struct {
	LexiconTypeID string `json:"$type,const=gndr.app.embed.record#viewNotFound" cborgen:"$type,const=gndr.app.embed.record#viewNotFound"`
	NotFound      bool   `json:"notFound" cborgen:"notFound"`
	Uri           string `json:"uri" cborgen:"uri"`
}

// EmbedRecord_ViewRecord is a "viewRecord" in the gndr.app.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewRecord
type EmbedRecord_ViewRecord struct {
	LexiconTypeID string                                `json:"$type,const=gndr.app.embed.record#viewRecord" cborgen:"$type,const=gndr.app.embed.record#viewRecord"`
...
func (t *EmbedRecord_View_Record) MarshalJSON() ([]byte, error) {
	if t.EmbedRecord_ViewRecord != nil {
		t.EmbedRecord_ViewRecord.LexiconTypeID = "gndr.app.embed.record#viewRecord"
		return json.Marshal(t.EmbedRecord_ViewRecord)
	}
	if t.EmbedRecord_ViewNotFound != nil {
		t.EmbedRecord_ViewNotFound.LexiconTypeID = "gndr.app.embed.record#viewNotFound"
		return json.Marshal(t.EmbedRecord_ViewNotFound)
	}
	if t.EmbedRecord_ViewBlocked != nil {
		t.EmbedRecord_ViewBlocked.LexiconTypeID = "gndr.app.embed.record#viewBlocked"
		return json.Marshal(t.EmbedRecord_ViewBlocked)
	}
	if t.EmbedRecord_ViewDetached != nil {
		t.EmbedRecord_ViewDetached.LexiconTypeID = "gndr.app.embed.record#viewDetached"
		return json.Marshal(t.EmbedRecord_ViewDetached)
	}
	if t.FeedDefs_GeneratorView != nil {
		t.FeedDefs_GeneratorView.LexiconTypeID = "gndr.app.feed.defs#generatorView"
		return json.Marshal(t.FeedDefs_GeneratorView)
	}
	if t.GraphDefs_ListView != nil {
		t.GraphDefs_ListView.LexiconTypeID = "gndr.app.graph.defs#listView"
	...
	if t.GraphDefs_StarterPackViewBasic != nil {
		t.GraphDefs_StarterPackViewBasic.LexiconTypeID = "gndr.app.graph.defs#starterPackViewBasic"
...
func (t *EmbedRecord_View_Record) UnmarshalJSON(b []byte) error {
	...
	case "gndr.app.graph.defs#starterPackViewBasic":
