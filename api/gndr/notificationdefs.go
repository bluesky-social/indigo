...
// schema: gndr.app.notification.defs

// NotificationDefs_ActivitySubscription is a "activitySubscription" in the app.gndr.notification.defs schema.
type NotificationDefs_ActivitySubscription struct {
	Post  bool `json:"post" cborgen:"post"`
	Reply bool `json:"reply" cborgen:"reply"`
}

// NotificationDefs_ChatPreference is a "chatPreference" in the app.gndr.notification.defs schema.
type NotificationDefs_ChatPreference struct {
	Include string `json:"include" cborgen:"include"`
	Push    bool   `json:"push" cborgen:"push"`
}

// NotificationDefs_FilterablePreference is a "filterablePreference" in the gndr.app.notification.defs schema.
...
// NotificationDefs_Preference is a "preference" in the gndr.app.notification.defs schema.
type NotificationDefs_Preference struct {
	List bool `json:"list" cborgen:"list"`
	Push bool `json:"push" cborgen:"push"`
}

// NotificationDefs_Preferences is a "preferences" in the gndr.app.notification.defs schema.
...
// NotificationDefs_RecordDeleted is a "recordDeleted" in the gndr.app.notification.defs schema.
type NotificationDefs_RecordDeleted struct {
}

// NotificationDefs_SubjectActivitySubscription is a "subjectActivitySubscription" in the app.gndr.notification.defs schema.
//
