...
// schema: app.gndr.notification.putActivitySubscription
...
// NotificationPutActivitySubscription_Input is the input argument to a app.gndr.notification.putActivitySubscription call.
...
func NotificationPutActivitySubscription(ctx context.Context, c util.LexClient, input *NotificationPutActivitySubscription_Input) (*NotificationPutActivitySubscription_Output, error) {
	...
	if err := c.LexDo(ctx, util.Procedure, "application/json", "app.gndr.notification.putActivitySubscription", nil, input, &out); err != nil {
		return nil, err
	}
