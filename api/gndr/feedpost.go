...
func init() {
	util.RegisterType("gndr.app.feed.post", &FeedPost{})
} //
// RECORDTYPE: FeedPost
type FeedPost struct {
	LexiconTypeID string `json:"$type,const=gndr.app.feed.post" cborgen:"$type,const=gndr.app.feed.post"`
	...
	// entities: DEPRECATED: replaced by gndr.app.richtext.facet.
...
func (t *FeedPost_Embed) MarshalJSON() ([]byte, error) {
	...
	if t.EmbedRecordWithMedia != nil {
		t.EmbedRecordWithMedia.LexiconTypeID = "gndr.app.embed.recordWithMedia"
...
func (t *FeedPost_Embed) UnmarshalJSON(b []byte) error {
	...
	case "gndr.app.embed.recordWithMedia":
...
// FeedPost_Entity is a "entity" in the gndr.app.feed.post schema.
//
...
// FeedPost_ReplyRef is a "replyRef" in the gndr.app.feed.post schema.
...
// FeedPost_TextSlice is a "textSlice" in the gndr.app.feed.post schema.
//
// Deprecated. Use gndr.app.richtext instead -- A text segment. Start is inclusive, end is exclusive. Indices are for utf16-encoded strings.
