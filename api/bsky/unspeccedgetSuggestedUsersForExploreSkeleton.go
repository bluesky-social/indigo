...
// Lexicon schema: app.bsky.unspecced.getSuggestedUsersForExploreSkeleton
...
func UnspeccedGetSuggestedUsersForExploreSkeleton(ctx context.Context, c lexutil.LexClient, category string, limit int64, viewer string) (*UnspeccedGetSuggestedUsersForExploreSkeleton_Output, error) {
	...
	if err := c.LexDo(ctx, lexutil.Query, "", "app.bsky.unspecced.getSuggestedUsersForExploreSkeleton", params, nil, &out); err != nil {
		return nil, err
	}
