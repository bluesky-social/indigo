...
func UnspeccedGetTaggedSuggestions(ctx context.Context, c lexutil.LexClient) (*UnspeccedGetTaggedSuggestions_Output, error) {
	...
	if err := c.LexDo(ctx, lexutil.Query, "", "app.bsky.unspecced.getTaggedSuggestions", nil, nil, &out); err != nil {
		return nil, err
	}
...
type UnspeccedGetTaggedSuggestions_Suggestion struct {
	LexiconTypeID string `json:"$type" cborgen:"$type,const=app.bsky.unspecced.getTaggedSuggestions#suggestion"`
