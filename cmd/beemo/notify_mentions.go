		...
		for _, feature := range facet.Features {
			...
			for _, d := range mc.mentionDIDs {
				if mention.Did == d.String() {
					...
					if post.Embed != nil && (post.Embed.EmbedImages != nil || post.Embed.EmbedGallery != nil || post.Embed.EmbedRecordWithMedia != nil || post.Embed.EmbedRecord != nil || post.Embed.EmbedExternal != nil) {
